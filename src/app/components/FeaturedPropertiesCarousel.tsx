...
import pent from "../../assets/Duplex-in-Nigeria.jpg";
import villa1 from "../../assets/villa1.jpg";
import apart from "../../assets/bungalow-nigeria.jpg";
import mans from "../../assets/house2.jpg";
...
<Link to="/listings">
        <button className="flex items-center gap-2 bg-primary text-primary-foreground px-6 py-2.5 rounded-lg hover:bg-primary/90 transition-colors mt-4">
          See More <ArrowRight />
        </button>
      </Link>
    </div>
